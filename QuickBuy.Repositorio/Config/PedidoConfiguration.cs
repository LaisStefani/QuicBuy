...
namespace QuickBuy.Repositorio.Config
{
    class PedidoConfiguration : IEntityTypeConfiguration<Pedido>
    {
        public void Configure(EntityTypeBuilder<Pedido> builder)
        {
            ...
            builder.Property(p => p.DtaPrevisaoEntrada).IsRequired();
            ...
            builder.Property(p => p.EnderecoComplento).IsRequired().HasMaxLength(100);
            builder.Property(p => p.NumeroEdereco).IsRequired().HasMaxLength(100);
